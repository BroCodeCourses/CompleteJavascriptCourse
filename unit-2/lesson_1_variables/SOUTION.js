...
/**
 * Print each of these variables with values to the console to see their values in the terminal.
 ...
 */
const instructors = 'BroCodeCourses';
const unit = 2;
const unitAndLesson = 2.1;
const isLessonDone = true;
const grade = 'A';

console.log(`instructors: ${instructors}`);
console.log(`unit: ${unit}`);
console.log(`unit and lesson: ${unitAndLesson}`);
